...
The selected files under `stylized-nature/` come from the Quaternius
Stylized Nature MegaKit Standard pack.
...
`assets/glyphweave.registry.json` at the same time.
